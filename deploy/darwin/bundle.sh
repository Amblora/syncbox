...
# NO code signing - unsigned is more compatible than ad-hoc on macOS 26+
# User must run: xattr -cr SyncBox.app
echo "=== Bundle created (unsigned) ==="
echo "Keep raw binary for direct terminal use"
